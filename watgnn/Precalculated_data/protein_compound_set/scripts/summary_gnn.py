...
methods = [ 'WatGNN','3D-RISM','GalaxyWater-CNN']

for method in methods:
    with open('%s_test.log'%method,'r') as f:
        lines = f.readlines()
        out05 = open('summary/%s_test_c0.5.txt'%method,'w')
        out10 = open('summary/%s_test_c1.0.txt'%method,'w')
        out15 = open('summary/%s_test_c1.5.txt'%method,'w')
        out20 = open('summary/%s_test_c2.0.txt'%method,'w')
